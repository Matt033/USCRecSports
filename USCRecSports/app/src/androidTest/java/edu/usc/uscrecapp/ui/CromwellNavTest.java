...
public class CromwellNavTest {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void cromwellNavTest() {
        ...
        ViewInteraction materialButton2 = onView(
                allOf(withId(R.id.Cromwell), withText("Cromwell Track"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withText("Reservation - Cromwell Track"),
                        withParent(allOf(withId(androidx.appcompat.R.id.action_bar),
                                withParent(withId(androidx.appcompat.R.id.action_bar_container)))),
                        isDisplayed()));
        textView.check(matches(withText("Reservation - Cromwell Track")));
    }
