...
public class VillageNavTest {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void villageNavTest() {
        ...
        ViewInteraction materialButton2 = onView(
                allOf(withId(R.id.Village), withText("Village Gym"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withText("Reservation - UV Fitness Center"),
                        withParent(allOf(withId(androidx.appcompat.R.id.action_bar),
                                withParent(withId(androidx.appcompat.R.id.action_bar_container)))),
                        isDisplayed()));
        textView.check(matches(withText("Reservation - UV Fitness Center")));
    }
