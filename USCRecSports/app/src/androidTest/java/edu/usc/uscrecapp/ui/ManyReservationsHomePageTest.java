...
public class ManyReservationsHomePageTest {
    ...
    @Test
    public void manyReservationsHomePageTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.Summary),
                        ...
                        isDisplayed()));
        textView.check(matches(withText("View your 4 upcoming reservations on \n2024-04-09,\n2024-05-09,\n2024-06-09,\n etc")));
        ...
        protected Void doInBackground(Void...voids){
            try{
                ...
                String sql2 = "INSERT INTO reservations(user_id,timeslot_id,location_id,date,availability_id) VALUES(3,3,1,'2024-04-09',20)"+
                        ", (3,3,1,'2024-05-09',20), (3,3,1,'2024-06-09',20), (3,3,1,'2024-07-09',20);";
