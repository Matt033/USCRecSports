...
public class MultipleWaitlistNotificationVerification {
    ...
    public class NotificationAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void...voids){
            try{
                ...
                String sql7 = "INSERT INTO waiting_lists(user_id, timeslot_id,location_id,date,availability_id)\n" +
                        "VALUES(2,1,1,'2022-04-12',1000);";
    ...
    public class DeleteAsync extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void...voids){
            try{
                ...
                String sql4 = "DELETE FROM waiting_lists WHERE user_id=2";
                stmt.executeUpdate(sql4);
